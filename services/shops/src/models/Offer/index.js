...
const schema = new mongoose.Schema(
  {
    ...
    enableVariantSelection: { type: Boolean, required: false, default: false },
    enableQuantitySelection: { type: Boolean, required: false, default: false },
    limitQuantitySelection: { type: Boolean, required: false, default: false },
